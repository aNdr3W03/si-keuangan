...
if (!empty($isi['pendaftaran'])) {
 ?>
                 <thead><tr> <th colspan="4" style="size: 16px; background-color: #33DD90;">Uang Pendaftaran</th></tr></thead>
                <tbody>
                    <tr>
...
?>
				<thead><tr><th colspan="4" style="size: 16px; background-color: #33DD90;">UANG UJIAN</th></tr></thead>
                <tbody>
                    <tr>
                      <th>Nama Siswa</th>
                      <th>Periode</th>
...
<?php }
 ...
 if (!empty($isi['snack'])) {
 ?>
				<thead><tr><th colspan="4" style="size: 16px; background-color: #33DD90;">UANG SNACK</th></tr></thead>
                <tbody>
                    <tr>
                      <th>Nama Siswa</th>
                      <th>Jumlah Hari</th>
...
<?php }
 ...
 ?>
				<thead><tr><th colspan="4" style="size: 16px; background-color: #33DD90;">UANG CATERING</th></tr></thead>
                <tbody>
                    <tr>
                      <th>Nama Siswa</th>
                      <th>Jumlah Hari</th>
...
<?php }
if (!empty($isi['spp'])) { ?>
                <thead><tr> <th colspan="4" style="background-color: #33DD90;">SPP</th></tr></thead>
                <tbody>
                    <tr>
                      <th>Nama Siswa</th>
                      <th>Bulan</th>
...
<?php }
 ...
 ?>
                <thead><tr> <th colspan="4" style="size: 16px; background-color: #33DD90;">Lainnya</th></tr></thead>
                <tbody>
                    <tr>
...
<?php } ?>
                  <tr style="size: 18; background-color: #00A65A; color: #ffffff">
...
if (!empty($isi['gaji'])) {
 ?>
            	<thead><tr><th colspan="4" style="background-color: #EE7777;">GAJI GURU</th></tr></thead>
                <tbody>
                    <tr>
                      <th>Nama Guru</th>
                      <th>Bulan</th>
...
if (!empty($isi['pengeluaran'])) {
             ?>
				<thead><tr><th colspan="4" style="size: 16px; background-color: #EE7777;">Pengeluaran Lainnya</th></tr></thead>
                <tbody>
                    <tr>
                      <th colspan="2">Keterangan</th>
                      <th colspan="2">Nominal</th>
		...
		foreach ($isi['pengeluaran'] as $k) { ?>
         ...
         <?php
            $total+=$k->nominal;
                  ...
                  <tr style="size: 18; background-color: #DD4B39; color: #ffffff">

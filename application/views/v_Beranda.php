    ...
    <div class="box box-danger">
        ...
        <div class="box-body text-center">
            <div class="jumbotron jumbotron-fluid" style="background-color:white;">
                <div class="container">
                 	<img style="width: 15%" src="<?=base_url('assets/dist/img/logo_harum_sentosa_baru.png')?>">
                    <h2 class="display-4" style="color:#7E0000;">SISTEM INFORMASI KEUANGAN</h2>
                    <p class="lead" style="color:#AA0000">YAYASAN HARUM SENTOSA BARU</p>
                </div>
            </div>
